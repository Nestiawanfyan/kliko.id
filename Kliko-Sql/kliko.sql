...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Bulan Mei 2018 pada 05.31
...
(1, 'Niki Rahmadi Wiharto', 'niki@gmail.com', '', 'nikirahmadi', '$2y$10$YKG8Qkico42LP4Xm3Gyyc./8qd84aKpAulg9l7uPZHbEremzbRSJa', 'KfrxqGxJW4KBGAZpYxVj3GqRS7eCTshjFHbeQdlcfY9YBSovWmPb0LGFXRow', '2017-01-15 15:32:46', '2018-05-18 21:08:07'),
(2, 'Nestiawan Ferdiyanto', 'p.nestiawan@gmail.com', '1526702790.png', 'nestiawan', '$2y$10$6DWvE89yLillC2bD5KDOiOKhyGqF2GNgrIlox2b8u8t8yvJvk2l1u', NULL, '2018-05-18 21:06:32', '2018-05-18 21:06:32');

-- --------------------------------------------------------

--
-- Struktur dari tabel `fasilitas_kamar_mandi`
--
...
--
-- Dumping data untuk tabel `fasilitas_kamar_mandi`
--
...
--
-- Struktur dari tabel `fasilitas_khusus`
--
...
--
-- Dumping data untuk tabel `fasilitas_khusus`
--
...
--
-- Struktur dari tabel `fasilitas_lingkungan`
--
...
--
-- Dumping data untuk tabel `fasilitas_lingkungan`
--
...
INSERT INTO `fasilitas_ruangan` (`id`, `nama`, `created_at`, `updated_at`) VALUES
(1, 'Ruang Keluarga', '2018-05-14 13:11:17', NULL),
(2, 'Ruang Dapur', '2018-05-14 13:11:17', NULL),
(3, 'Ruang Tamu', '2018-05-14 13:11:17', NULL),
(4, 'Dapur', '2018-05-14 13:11:17', NULL),
(5, 'Halaman Depan', '2018-05-14 13:11:17', NULL),
(6, 'Halaman Belakang', '2018-05-14 13:11:17', NULL),
(7, 'Teras', '2018-05-14 13:11:17', NULL);
...
--
-- Struktur dari tabel `jenis_hunian`
--
...
--
-- Dumping data untuk tabel `jenis_hunian`
--
...
--
-- Struktur dari tabel `jenis_listrik`
--
...
--
-- Dumping data untuk tabel `jenis_listrik`
--
...
(10, 3, 'wisma-srisendono', 'Supriyanto', '08080808', 'Jalan Arabika No. 002, Rajabasa, Bandar Lampung', 1, 'Wisma Srisendono', 'Jalan Arabika No. 002, Rajabasa, Bandar Lampung', NULL, '', '4x4', 40, 0, 'Campur', -5.371735264963359, 105.23609716850888, 1, 0, 0, 0, 3750000, '', 'Listrik', '', '', 1, 'Wisma dekat dengan kampus (Unila, UMITRA)\nLokasi juga dekat dengan terminal Rajabasa, Robinson\nAda warung\nSuasana kondusif', 1, NULL, NULL, '2017-05-16 08:08:18', '2017-05-16 08:27:57'),
...
(30, 15, 'sdfasd', 'Nestiawan', '123456789098', 'sdadsasdasda as', 0, 'sdfasd', 'sdf dsf asdfadsfadf', 12345, '123456789098', '4x3', 3, 3, 'Putri', -5.3971396, 105.2667887, 11, 300000, 900000, 1200000, 3000000, '', '', '', '', 0, '', 1, NULL, NULL, '2018-05-19 01:11:39', '2018-05-19 01:11:39'),
(31, 15, 'sdfasd-1', 'Nestiawan', '123456789098', 'sdadsasdasda as', 0, 'sdfasd', 'sdf dsf asdfadsfadf', 12345, '123456789098', '4x3', 3, 3, 'Putri', -5.3971396, 105.2667887, 11, 300000, 900000, 1200000, 3000000, '', '', '', '', 0, '', 1, NULL, NULL, '2018-05-19 01:12:42', '2018-05-19 01:12:42'),
(32, 15, 'asdasdasod', '.dsjkf ;adslf asid', '12121212112', 'kd asdoasid aoids ', 0, 'asdasdasod', 'asiodhaosdhoa sdoias', 12121, '12312312321', '4x9', 2, 2, 'Putra', -5.3971396, 105.2667887, 1, 900000, 900000, 900000, 900000, '', '', '', '', 0, '', 1, NULL, NULL, '2018-05-19 01:24:33', '2018-05-19 01:24:33'),
(33, 15, 'asdasdasod-1', '.dsjkf ;adslf asid', '12121212112', 'kd asdoasid aoids ', 0, 'asdasdasod', 'asiodhaosdhoa sdoias', 12121, '12312312321', '4x9', 2, 2, 'Putra', -5.3971396, 105.2667887, 1, 900000, 900000, 900000, 900000, '', '', '', '', 0, '', 1, NULL, NULL, '2018-05-19 01:55:52', '2018-05-19 01:55:52');

-- --------------------------------------------------------

--
-- Struktur dari tabel `kost_fk`
--
...
--
-- Dumping data untuk tabel `kost_fk`
--
...
--
-- Dumping data untuk tabel `kost_fkm`
--
...
--
-- Dumping data untuk tabel `kost_fl`
--
...
--
-- Dumping data untuk tabel `kost_fu`
--
...
--
-- Struktur dari tabel `kost_parkir`
--
...
--
-- Dumping data untuk tabel `kost_parkir`
--
...
--
-- Dumping data untuk tabel `parkirs`
--
...
(2, 'Niko Rahmadi Wiharto', 'nikorahmadiwiharto@gmail.com', '', 'nikorahmadi', '$2y$10$Clinrv0yyL5tK1uy4KvaReK7nmtbjNahUVyRhZnawubJi2suconLe', 0, '$2y$10$D4ulbmJqB.wlynga0RMpd.j.AX/U/idKQYgZ7hOlPQVYEiY4D4hM6', NULL, '2017-01-18 21:25:42', '2018-05-18 21:41:07'),
...
(15, 'Nestiawan', 'p.nestiawan@gmail.com', '', 'nestiawan', '$2y$10$oPNWWXKRASVWYXZuTa3uzOFCrVbVKa7PK6ZGMzEo/VhIk1xwWMY2G', 1, NULL, 'zUwcEpN67AYOuw1BXKZq9DsDhq6JWMALHKgKMgsVgia67rBXzpdgBwI9M41P', '2017-06-05 21:48:17', '2018-05-18 21:39:29'),
...
--
-- Indeks untuk tabel `fasilitas_kamar_mandi`
--
ALTER TABLE `fasilitas_kamar_mandi`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `fasilitas_khusus`
--
ALTER TABLE `fasilitas_khusus`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `fasilitas_lingkungan`
--
...
--
-- Indeks untuk tabel `jenis_hunian`
--
ALTER TABLE `jenis_hunian`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `jenis_listrik`
--
...
--
-- Indeks untuk tabel `kost_parkir`
--
...
--
-- AUTO_INCREMENT untuk tabel `fasilitas_kamar_mandi`
--
ALTER TABLE `fasilitas_kamar_mandi`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `fasilitas_khusus`
--
ALTER TABLE `fasilitas_khusus`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `fasilitas_lingkungan`
--
ALTER TABLE `fasilitas_lingkungan`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT untuk tabel `jenis_hunian`
--
ALTER TABLE `jenis_hunian`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `jenis_listrik`
--
ALTER TABLE `jenis_listrik`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT untuk tabel `kost_fk`
--
ALTER TABLE `kost_fk`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;

--
-- AUTO_INCREMENT untuk tabel `kost_fkm`
--
ALTER TABLE `kost_fkm`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT untuk tabel `kost_fl`
--
ALTER TABLE `kost_fl`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT untuk tabel `kost_fu`
--
ALTER TABLE `kost_fu`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT untuk tabel `kost_parkir`
--
ALTER TABLE `kost_parkir`
...
--
-- AUTO_INCREMENT untuk tabel `parkirs`
--
ALTER TABLE `parkirs`
...
--
-- Ketidakleluasaan untuk tabel `kost_fk`
--
ALTER TABLE `kost_fk`
...
--
-- Ketidakleluasaan untuk tabel `kost_fkm`
--
ALTER TABLE `kost_fkm`
...
--
-- Ketidakleluasaan untuk tabel `kost_fl`
--
ALTER TABLE `kost_fl`
...
--
-- Ketidakleluasaan untuk tabel `kost_fu`
--
ALTER TABLE `kost_fu`
...
--
-- Ketidakleluasaan untuk tabel `kost_parkir`
--
ALTER TABLE `kost_parkir`

...
<head>
  ...
  <body>
    ...
    <div class="container text-xs-center error-page text-danger">
      <h1 class="title">!!!</h1>
      <div style="font-size:25px; font-weight: 300; padding-bottom: 15px;">PENCARIAN TIDAK DITEMUKAN</div>
      <div style="padding-bottom: 15px;">Kata kunci yang Anda gunakan untuk mencari mungkin tidak cocok dengan data manapun.<br>
